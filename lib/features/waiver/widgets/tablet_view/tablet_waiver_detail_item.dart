...
class TabletWaiverDetailItem extends StatefulWidget {
  const TabletWaiverDetailItem({super.key, required this.passenger, required this.gender, required this.weightType, required this.country, required this.specialRequests});

  final Map<String, dynamic> passenger;
  final List<String> gender, weightType, country, specialRequests;

  @override
  State<TabletWaiverDetailItem> createState() => _TabletWaiverDetailItemState();
}

class _TabletWaiverDetailItemState extends State<TabletWaiverDetailItem> {
  @override
